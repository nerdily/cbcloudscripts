...
# data = {"criteria": {"group_results": "false", "minimum_severity": "1", "category": ["THREAT"],
#                      "workflow": ["DISMISSED", "OPEN"], "alert_type": ["CB_ANALYTICS"],
#                      "create_time": {"range": "all"}}, "query": "", "sort": [{"field": "create_time", "order": "DESC"}],
#         "start": 0, "rows": 10000}
#
